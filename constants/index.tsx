...
export const chatData = [
  {
    ...
    age: 32,
    isOnline: true,
    lastMessage: 'That sounds like a lot of fun. Would you like to go together sometime?',
    date: '2023-10-15',
    timeSent: '5 mins',
    chat: [
      {
  ...
  },
  {
    ...
    chat: [
      ...
      {
        sender: 'me',
        message: 'Absolutely, breaks are necessary. Planning anything fun for the evening? 🎉',
        timestamp: '2:20 PM',
      },
      {
        sender: 'Oliver',
  ...
  },
  {
    ...
    chat: [
      ...
      {
        sender: 'me',
        message: "Not yet, but I'm thinking of checking out that new restaurant downtown. You?",
        timestamp: '3:20 PM',
      },
      {
        sender: 'Sophie',
        message: "I'm planning to go hiking with some friends. You should join us sometime!",
        timestamp: '3:25 PM',
      },
    ],
  },
